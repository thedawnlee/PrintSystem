...
public class TencentMsgUtil {
    ...
    /* 短信应用SDK AppID */
    private static int  appid = 1400202040;

    /* 短信应用SDK AppKey */
    private static String appkey = "4683b8eadd9f29671bd2c08daa2e5e33";

    /* 短信模板ID，需要在短信应用中申请 */
    private static int sendTemplateId = 316439;

    /* 短信模板ID，需要在短信应用中申请 */
    private static int refuseTemplateId = 316720;

    /* 签名 */
    private static String smsSign = "久一软件";


    public static boolean sendMessage (MessageParamDto paramDto) {
