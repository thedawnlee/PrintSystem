...
import com.dawn.dao.OrderItemMapper;
import com.dawn.dao.OrderMasterMapper;
import com.dawn.dao.PayInfoMapper;
import com.dawn.enums.OrderStatusEnum;
import com.dawn.enums.PayPlatformEnum;
import com.dawn.pojo.OrderItem;
import com.dawn.pojo.OrderMaster;
import com.dawn.pojo.PayInfo;
import com.dawn.service.IPayService;
import com.dawn.service.WebSocket;
import com.dawn.utils.BigDecimalUtil;
...
public class PayServiceImpl implements IPayService {
    ...
    public ServerResponse pay(String orderNo, Integer userId, String path) {
        ...
        for (OrderItem orderItem : orderItemList) {
            ...
            com.dawn.pojo.File file = fileMapper.selectByPrimaryKey(orderItem.getFileId());
