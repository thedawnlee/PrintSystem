...
import com.dawn.utils.TencentMailMsgUtil;
...
import com.dawn.enums.*;
import com.dawn.form.CreateOrderForm;
import com.dawn.pojo.*;
import com.dawn.service.IOrderService;
import com.dawn.utils.EnumUtil;
import com.dawn.utils.KeyUtil;
import com.dawn.utils.TencentMsgUtil;
import com.dawn.vo.GetKeyVo;
import com.dawn.vo.OrderListVo;
import com.dawn.vo.OrderVo;
import com.dawn.vo.OrderVoList;
import com.dawn.vo.backend.BackendOrderListVo;
import com.dawn.vo.backend.BackendOrderVo;
...
public class OrderServiceImpl implements IOrderService {
    ...
    public ServerResponse noticePackingForBackend( User user,  String getKey ,String orderNo ) {
        ...
        messageParamDto.setEmail(orderMaster.getBuyerEmail());
        ...
        boolean mailmessageResult = false;
        ...
        try {
            ...
            mailmessageResult = isendMailService.sendSimpleMail(messageParamDto.getEmail(), subject, content);

        } catch (Exception e) {
            e.printStackTrace();
        }

        if ( messageResult ||mailmessageResult ){
    ...
    public ServerResponse refuseOrderForBackend( User user,  String reason , String fileName ,String orderNo ) {
        ...
        String subject = "订单拒绝";
        /* {1}{2}拒绝，{3}，{4} 。 */
        String content = "尊敬的用户，您所打印文件"+messageParamDto.getParam1()+"被打印店"+messageParamDto.getParam2()+"拒绝，原因为："+messageParamDto.getParam3()+"如果有疑问请联系"+messageParamDto.getParam4();
        try {
            messageResult = TencentMsgUtil.sendMessage(messageParamDto);
                            isendMailService.sendSimpleMail(messageParamDto.getEmail(),subject,content);
        } catch (Exception e) {
            e.printStackTrace();
        }
