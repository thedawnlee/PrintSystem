...
public class FTPUtil {
    ...
    private  static  String ftpPass = "Lisantao1";
    ...
    private boolean  download(String remotePath, String newFileName, String targetFilePath) throws IOException {
        ...
        if(connectServer(this.ip,this.port,this.user,this.pwd)){
            ...
            log.info("长度为"+fos.toString());
            ftpClient.retrieveFile(new String(newFileName.getBytes("GB2312"),"ISO-8859-1"), fos); //开始下载文件
